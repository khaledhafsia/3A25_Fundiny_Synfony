...
class ReponsesController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager, Request $request, ReponsesRepository $reponsesRepository, PaginatorInterface $paginator, SessionInterface $session): Response
    {

        $User = $session->get('user_id');
        $reponses = $reponsesRepository->findByUserId($User);
        ...
        return $this->render('front/reponses/index.html.twig', [
            'reponses' => $pagination, $reponses,
        ]);
    }

    #[Route('/b', name: 'app_reponsesb_index', methods: ['GET'])]
    public function indexb(EntityManagerInterface $entityManager, Request $request, ReponsesRepository $reponsesRepository, PaginatorInterface $paginator): Response
    {
        // Get the search query from the request
        ...
        // Render the view with the search results
        return $this->render('back/reponses/index.html.twig', [
            'reponses' => $pagination, $reponses,
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('front/reponses/new.html.twig', [
            'reponse' => $reponse,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('front/reponses/show.html.twig', [
            'reponse' => $reponse,
        ]);
    }
    ...
    public function edit(Request $request, Reponses $reponse, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('front/reponses/edit.html.twig', [
            'reponse' => $reponse,
            'form' => $form,
        ]);
    }
...
//    #[Route("/pdf", name: "reponses_pdf")]
    ...
    public function generateRolePdf(ReponsesRepository $reponsesRepository, Request $request): Response
    {
        ...
        $html = $this->renderView('front/reponses/pdf_export.html.twig', [
            'reponses' => $reponse
        ]);
        dump($html);
